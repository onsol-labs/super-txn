...
/**
 *  This is almost completely copy-pasted from solana-web3.js and slightly adapted to work with "wrapped" transaction messaged such as in SuperTransaction.
...
export class CompiledKeys {
   ...
   * This allows to compress the message size and avoid hitting the tx size limit during super_transaction_create instruction calls.
   */
  static compile(
